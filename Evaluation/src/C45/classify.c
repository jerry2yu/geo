...
/**********************************************************
 * Return a category with confidence value as a float
 * you must call-by-reference, with &confidence, otherwise
 * it won't work!
 **********************************************************/

ClassNo CategoryWt(CaseDesc, DecisionTree, confidence) 
     Description CaseDesc; 
     Tree DecisionTree; 
     float  *confidence; /* call-by-reference */
{ 
  ClassNo c, BestClass;
