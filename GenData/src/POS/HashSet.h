...
private:
	HashSetEntry **buckets;	/* Pointer to an array of buckets */
	unsigned int bucketCount;	/* total number of buckets */
	unsigned int count;		/* Current count */
	unsigned int threshold;	/* loadFactor threshold */
	float  loadFactor;		/* Current loadFactor (count/bucketCount) */
	HashFunction hashfn;
